...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Product::create([
            ...
            'image_url' => '/storage/products/asus-tuf-gaming-a15-fa507nv.jpg',
            'image_thumbnail_url' => '/storage/products/asus-tuf-gaming-a15-fa507nv.jpg',
            'stock' => 1,
        ...
        Product::create([
            ...
            'price' => 14300000,
            'sku' => 'ASUS-ROG-G513QM',
            'image_url' => '/storage/products/asus-rog-strix-g513qm.jpg',
            'image_thumbnail_url' => '/storage/products/asus-rog-strix-g513qm.jpg',
            'stock' => 1,
            'specifications' => json_encode([
        ...
        Product::create([
            ...
            'image_url' => '/storage/products/acer-aspire-A314-23M.webp',
            'image_thumbnail_url' => '/storage/products/acer-aspire-A314-23M.webp',
            'stock' => 1,
            'specifications' => json_encode([
        ...
        Product::create([
            ...
            'price' => 5500000,
            'sku' => 'HP-14-EM0014',
            'image_url' => '/storage/products/hp-laptop-14-em0014.jpg',
            'image_thumbnail_url' => '/storage/products/hp-laptop-14-em0014.jpg',
            'stock' => 1,
            'specifications' => json_encode([
        ...
        Product::create([
            ...
            'price' => 5000000,
            'sku' => 'LENOVO-SLIM3I',
            'image_url' => '/storage/products/lenovo-ideapad-slim-3i.jpg',
            'image_thumbnail_url' => '/storage/products/lenovo-ideapad-slim-3i.jpg',
            'stock' => 1,
            'specifications' => json_encode([
        ...
        Product::create([
            ...
            'price' => 4000000,
            'sku' => 'ACER-LITE14',
            'image_url' => '/storage/products/acer-aspire-lite-14.webp',
            'image_thumbnail_url' => '/storage/products/acer-aspire-lite-14.webp',
            'stock' => 1,
            'specifications' => json_encode([
        ...
        Product::create([
            ...
            'price' => 3300000,
            'sku' => 'ASUS-E410M',
            'image_url' => '/storage/products/asus-vivobook-1410M.webp',
            'image_thumbnail_url' => '/storage/products/asus-vivobook-1410M.webp',
            'stock' => 1,
            'specifications' => json_encode([
